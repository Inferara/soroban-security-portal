...
import { ExpertiseTagsInput } from '../../../../features/components/expertise-tags-input';
import { CharacterCounter } from '../../../../features/components/character-counter';
...
export const EditProfile: React.FC = () => {
    ...
    const validateWebsite = () => {
        setWebsiteError(
            website && !isValidWebsiteUrl(website)
    ...
    const validateTwitter = () => {
        setTwitterError(
            twitter && !isValidTwitterUrl(twitter)
                ? 'Enter a valid Twitter/X profile URL, e.g. https://twitter.com/username'
                : '',
        );
    };
    ...
    const validateGithub = () => {
        setGithubError(
            github && !isValidGitHubUrl(github)
    ...
    const handleSaveProfile = async () => {
        ...
        if (websiteError || twitterError || githubError) {
            ...
            <Box sx={{ margin: '0 auto' }}>
                ...
                <ContentSection>
                    ...
                    <TextField
                        ...
                        placeholder="Tell the community about your background in smart contract security…"
                        error={bio.length > MAX_BIO_LENGTH}
                        helperText={bio.length > MAX_BIO_LENGTH ? `Bio must be ${MAX_BIO_LENGTH} characters or fewer` : ''}
                    />
